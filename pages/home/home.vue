<template>
	<view class="home">
		...
		<view class="section-kinds">
			<navigator v-for="item in kindList" class="kind-block" :key="item.id"
				:url="'/kindPackage/list/list?kindId=' + item.id">
			...
			<view class="product-list-main">
				<view class="product-list">
					<navigator class="product-block" :key="item.id"
						:url="'/kindPackage/list/info/info?productId=' + item.id"
						v-for="(item, index) in saleMostProducts">
